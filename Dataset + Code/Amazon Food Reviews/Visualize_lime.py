...
# model_RB.load_state_dict(torch.load("Dataset/Restaurant Reviews/model/roberta.pt"))
...
for i in range(0,2):
    ...
    exp.save_to_file('Dataset/Restaurant Reviews/html/bert_example{}.html'.format(i))
    ...
    exp.save_to_file('Dataset/Restaurant Reviews/html/Albert_example{}.html'.format(i))
    ...
    exp.save_to_file('Dataset/Restaurant Reviews/html/SVM_example{}.html'.format(i))
