...
classifier_linear.fit(train_vectors, df_RR['Liked'])
...
pickle.dump(classifier_linear, open('Dataset/Restaurant Reviews/model/svm.pkl', 'wb'))

#%%
# load the model from disk
loaded_model = pickle.load(open('Dataset/Restaurant Reviews/model/svm.pkl', 'rb'))
