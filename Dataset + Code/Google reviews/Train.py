...
for i in np.array(df_GR.iloc[:,0]):
    txt.append(i)
...
#%%
text_batch = txt
label_batch = np.array(df_GR.iloc[:,1])
#%%
...
torch.save(model_B.state_dict(), "Dataset/Google reviews/model/g_bert.pt")
#%%

torch.save(model_RB.state_dict(), "Dataset/Google reviews/model/g_roberta.pt")
#%%

torch.save(model_AB.state_dict(), "Dataset/Google reviews/model/g_albert.pt")
#%%
